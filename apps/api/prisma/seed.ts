...
Great progress everyone. Let's sync again tomorrow. Meeting adjourned.`,
      segments: [
        { start: 0, end: 5, text: "Good morning everyone. Let's start with our weekly standup.", speaker: 'Host' },
        { start: 5, end: 8, text: 'John, can you start us off?', speaker: 'Host' },
        { start: 8, end: 25, text: "Sure. Yesterday I finished the authentication module and submitted it for review. Today I'll be working on the dashboard components. No blockers.", speaker: 'John' },
        { start: 25, end: 28, text: 'Thanks John. Sarah?', speaker: 'Host' },
        { start: 28, end: 55, text: "I've been working on the API integration. Had some issues with the third-party service but resolved them. Today I'll continue with testing. One blocker - I need access to the staging environment.", speaker: 'Sarah' },
        { start: 55, end: 62, text: "I'll get you that access right after this meeting. Mike?", speaker: 'Host' },
        { start: 62, end: 82, text: 'I completed the database migrations and started on the caching layer. Will continue that today. No blockers from my side.', speaker: 'Mike' },
        { start: 82, end: 90, text: "Great progress everyone. Let's sync again tomorrow. Meeting adjourned.", speaker: 'Host' },
      ],
      language: 'en',
    },
  });
...
3. Schedule next sync for tomorrow`,
      sections: [
        { title: 'Overview', content: 'Team standup covering progress updates from John, Sarah, and Mike.', order: 0 },
        { title: 'Key Updates', content: 'John completed auth module. Sarah working on API integration with blocker. Mike finished migrations.', order: 1 },
        { title: 'Action Items', content: '1. Grant staging access to Sarah\n2. Review auth PR\n3. Schedule next sync', order: 2 },
      ],
    },
  });
...
Perfect. We can set you up with a 30-day trial for your sales team. I'll send over the proposal today.`,
      segments: [
        { start: 0, end: 8, text: 'Hello, thank you for taking the time to meet with us today.', speaker: 'Sales Rep' },
        { start: 8, end: 16, text: "Of course, we've been looking forward to learning more about your solution.", speaker: 'Prospect' },
        { start: 16, end: 35, text: "Great! Let me walk you through how Komuchi can transform your team's meeting workflows. We specialize in audio transcription and intelligent debriefing.", speaker: 'Sales Rep' },
        { start: 35, end: 45, text: "That sounds interesting. Our biggest pain point is keeping track of action items from calls.", speaker: 'Prospect' },
        { start: 45, end: 65, text: "That's exactly what we solve. After each call, our AI generates a structured debrief with action items, key decisions, and follow-ups automatically assigned.", speaker: 'Sales Rep' },
        { start: 65, end: 70, text: "What's the typical turnaround time?", speaker: 'Prospect' },
        { start: 70, end: 85, text: 'Usually within 2-3 minutes after the recording ends. Everything is searchable and integrates with your existing tools.', speaker: 'Sales Rep' },
        { start: 85, end: 92, text: "We'd like to start a pilot. What would that look like?", speaker: 'Prospect' },
        { start: 92, end: 105, text: "Perfect. We can set you up with a 30-day trial for your sales team. I'll send over the proposal today.", speaker: 'Sales Rep' },
      ],
      language: 'en',
    },
  });
...
4. Follow up in 1 week`,
      sections: [
        { title: 'Summary', content: 'Introductory sales call with strong interest. Pilot agreed.', order: 0 },
        { title: 'Pain Points', content: 'Action item tracking, meeting documentation, tool integration needs.', order: 1 },
        { title: 'Outcome', content: 'Pilot agreed - 30-day trial for sales team.', order: 2 },
        { title: 'Next Steps', content: 'Send proposal, set up pilot, schedule onboarding, follow up in 1 week.', order: 3 },
      ],
    },
  });
